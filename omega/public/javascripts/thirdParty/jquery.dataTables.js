...
(function($) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnScrollDraw ( o )
		{
			...
			o.nTable.style.width = (o.oScroll.sXInner !== "") ? o.oScroll.sXInner : "100%";
			...
			if ( oSettings.oScroll.sX === "" && oSettings.oScroll.sY !== "" )
			{
				...
				if ( iOrigWidth-oSettings.iScrollWidth != $(n).width() )
				{
					_fnLog( oSettings, 1, "The table cannot have the width of the scroll bar removed "+
						...
						"suggested that you enable x-scrolling or increase the width the table has in "+
						"which to be drawn" );
				}
			}
			else if ( oSettings.oScroll.sX !== "" )
