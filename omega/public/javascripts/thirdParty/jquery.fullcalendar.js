        ...
        this.each(function() {
            ...
            if (sections) {
                header = $("<div class='fc-header'/>")
                        ...
                        .append($("<div class='fc-header-left'/>").append(buildSection(sections.left)))
                        .append($("<div class='fc-header-center'/>").append(buildSection(sections.center)))
                        .append($("<div class='fc-header-right'/>").append(buildSection(sections.right)))
                        .prependTo(element);
            }
            function buildSection(buttonStr) {
                ...
                if (buttonStr) {
                    ...
                    $.each(buttonStr.split(' '), function(i) {
                        ...
                        $.each(this.split(','), function(j, buttonName) {
                            if (buttonName == 'title') {
                                tr.append("<h2 class='fc-header-title'>&nbsp;</h2>");
                                if (prevButton) {
                                    prevButton.addClass(tm + '-corner-right');
                                }
                                prevButton = null;
