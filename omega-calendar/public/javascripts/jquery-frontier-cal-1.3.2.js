...
(function($) {
    ...
    function Calendar() {
        ...
        this.do_init = function() {
            ...
            /**
             * public function to return the start date
             */
            this.getStartDate = function() {
                var firstDayPrevMonth = (daysInPreviousMonth - firstDayWkIndex) + 1;
                return  new Date(this.getCurrentYear(), this.getCurrentMonth(), firstDayPrevMonth).getTime()
            ...
            this.getEndDate = function() {
                var dtLast = new Date(this.getCurrentYear(), this.getCurrentMonth(), daysInCurrentMonth, 0, 0, 0, 0);
                var mstoadd = ((Calendar.dayNames.length - lastDayWkIndex - 1) * 86400000)
                var newdate = (dtLast.getTime() + mstoadd);
    ...
    var jFrontierCalPlugin = function(
         ...
         * @return A Date object. The date the calendar is currently set to (year & month)
         */
        this.getStartDate = function(calId) {
            if (calId != null) {
                calId = stripNumberSign(calId);
                var calObj = myCalendars.get(calId);
        ...
        this.getEndDate = function(calId) {
            if (calId != null) {
                calId = stripNumberSign(calId);
                var calObj = myCalendars.get(calId);
