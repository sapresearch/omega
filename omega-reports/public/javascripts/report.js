...
function drawAssetsGauge() {
    ...
    data.setValue(2, 0, 'Computers');
    data.setValue(2, 1, 42);
    data.setValue(3, 0, 'Projectors');
    data.setValue(3, 1, 77);
    data.setValue(4, 0, 'Others');
    data.setValue(4, 1, 55);

    var chart = new google.visualization.Gauge(document.getElementById('chart_div'));
    var options = {width: 700, height: 200, redFrom: 90, redTo: 100, yellowFrom:75, yellowTo: 90, minorTicks: 5};
